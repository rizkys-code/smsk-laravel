                ...
                <table class="table table-hover align-middle mb-0" id="suratTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <span class="badge bg-{{ $statusClass }} d-flex align-items-center gap-1 px-2 py-1">
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-1">
                                    <a href="{{ route('surat-keluar.show', $surat->id) }}" class="btn btn-sm btn-outline-primary" data-bs-toggle="tooltip" title="Lihat Detail">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    ...
                                    <a href="{{ route('surat-keluar.review', $surat->id) }}" class="btn btn-sm btn-outline-secondary" data-bs-toggle="tooltip" title="Revisi">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    @elseif ($surat->status === 'menunggu')
                                    <a href="{{ route('surat-keluar.review', $surat->id) }}" class="btn btn-sm btn-outline-warning" data-bs-toggle="tooltip" title="Review">
            ...
            <form action="{{ route('surat-keluar.store') }}" method="POST" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nomor_surat" class="form-control bg-light" value="" placeholder="Otomatis" readonly>
                    </div>
