                                    ...
                                    <td class="text-center">
                                        ...
                                        @if (Auth::user()->role == 'admin' && $surat->status == 'ditolak')
                                            <button type="button" class="btn btn-sm btn-warning mt-1"
                                                data-bs-toggle="modal" data-bs-target="#revisiModal{{ $surat->id }}">
                                                <i class="bi bi-pencil-square"></i> Revisi Data
                                            </button>

                                            <!-- Revisi Data Modal -->
                                            <div class="modal fade" id="revisiModal{{ $surat->id }}" tabindex="-1"
                                                aria-labelledby="revisiModalLabel{{ $surat->id }}" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="revisiModalLabel{{ $surat->id }}">Revisi Data Surat
                                                            </h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <form action="{{ route('surat-revisi.update', $surat->id) }}"
                                                            method="POST">
                                                            <div class="modal-body">
                                                                @csrf
                                                                @method('PATCH')
                                                                ...
                                                                <div class="row g-3">
                                                                    <div class="col-md-6">
                                                                        <label for="jenis_surat"
                                                                            class="form-label fw-medium">Jenis
                                                                            Surat</label>
                                                                        <div class="input-group">
                                                                            ...
                                                                            <select id="jenis_surat" name="jenis_surat"
                                                                                ...
                                                                                <option value="">-- Pilih Jenis Surat
                                                                                    --</option>
                                                                                <option value="SA"
                                                                                    {{ $surat->jenis == 'SA' ? 'selected' : '' }}>
                                                                                    Sertif Asisten / PKL</option>
                                                                                <option value="SS"
                                                                                    {{ $surat->jenis == 'SS' ? 'selected' : '' }}>
                                                                                    Sertif Webinar / Workshop / Media
                                                                                    Partner</option>
                                                                                <option value="H"
                                                                                    {{ $surat->jenis == 'H' ? 'selected' : '' }}>
                                                                                    Surat Perbaikan</option>
                                                                                <option value="P"
                                                                                    {{ $surat->jenis == 'P' ? 'selected' : '' }}>
                                                                                    Formulir Pendaftaran Calas</option>
                                                                                <option value="S"
                                                                                    {{ $surat->jenis == 'S' ? 'selected' : '' }}>
                                                                                    SK Asisten / Keterangan</option>
                                                                                <option value="U"
                                                                                    {{ $surat->jenis == 'U' ? 'selected' : '' }}>
                                                                                    Surat Undangan</option>
                                                                                <option value="K"
                                                                                    {{ $surat->jenis == 'K' ? 'selected' : '' }}>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="perihal"
                                                                            class="form-label fw-medium">Perihal
                                                                            Surat</label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text bg-light">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="nomor_surat"
                                                                            class="form-label fw-medium">Nomor
                                                                            Surat</label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text bg-light">
                                                                        ...
                                                                        <div class="form-text">Nomor surat tidak dapat
                                                                            diubah</div>
                                                                    </div>

                                                                    <div class="col-md-6">
                                                                        <label for="tanggal"
                                                                            class="form-label fw-medium">Tanggal
                                                                            Surat</label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text bg-light">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <label for="isi_surat"
                                                                            class="form-label fw-medium">Isi Surat</label>
